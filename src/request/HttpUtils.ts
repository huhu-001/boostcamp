 ...
 * @returns {*}
 */
const handleUrl = (url: string) => (params: { [x: string]: string | number | boolean }) => {
  if (params) {
 ...
 * @returns {Promise.<*>}
 */
const timeoutFetch = (original_fetch: Promise<Response>, timeout = 30000) => {
  let timeoutBlock = () => {}
...
export default class HttpUtils  {
   ...
   * @returns {Promise}
   */
  static getRequest = (url: string, params = {}) => {
   ...
   * @returns {Promise}
   */
  static postRequrst = (url: RequestInfo, params = {}) => {
